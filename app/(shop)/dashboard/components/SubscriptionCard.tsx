...
export function SubscriptionCard({ data }: Props) {
  ...
  if (!data) {
    return (
      <div className="bg-white/50 backdrop-blur-md p-5 sm:p-8 rounded-3xl border border-manto-teal/10 text-center flex flex-col items-center justify-center h-full min-h-[250px] shadow-sm">
  ...
  // 2. Estado "Suscrito"
  return (
    <div className="bg-manto-teal text-white p-5 sm:p-8 rounded-3xl shadow-lg relative overflow-hidden group h-full flex flex-col min-h-[250px]">
